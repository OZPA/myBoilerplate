...
<body class="body body--articlePage body--inquiry">
  ...
  <form id="toi" name="toi" action="inquiry-view.php" onsubmit="" method="post">
    ...
    <table class="table--inquiry">
      ...
      <tr>
        <td><span class="inquiry--required">※</span>郵便番号（ハイフン不要）</td>
        <td><input type="text" name="zip" id="zip" value="" size="10"></td>
      </tr>
      <tr>
        <td><span class="inquiry--required">※</span>都道府県</td>
        <td>
      ...
      <tr>
        <td><span class="inquiry--required">※</span>市区町村</td>
        <td><input type="text" name="address2" id="address2" value="" size="66"></td>
      </tr>
      <tr>
        <td><span class="inquiry--required">※</span>丁目番地、建物名など</td>
        <td><input type="text" name="address3" id="address3" value="" size="66"></td>
      </tr>
      <tr>
        <td><span class="inquiry--required">※</span>電話番号（半角数字）<span class="coOr"></span></td>
      ...
      <tr>
        <td><span class="inquiry--required">※</span>メールアドレス</td>
        <td><input type="text" name="email" id="email" value="" size="30" ></td>
      </tr>
      <tr>
        <td><span class="inquiry--required">※</span>ラジオ</td>
        <td>
          <ol id="radio">
